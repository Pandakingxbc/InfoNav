...
class ROSPublisher:
    def __init__(self):
        ...
        self.rgb_raw_pub = rospy.Publisher("/habitat/camera_rgb_raw", Image, queue_size=10)  # Raw image without detection boxes
    ...
    def publish_rgb_raw(self, ros_time, rgb_image):
